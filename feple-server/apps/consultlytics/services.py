...
1. 평가점수 (100점 만점, 숫자만)
2. 상담자 강점(상담사가 잘한 점을 근거와 함께 설명)
3. 상담자 단점(상담사가 못한 점을 근거와 함께 설명)
4. 개선점(상담 품질 향상을 위해 실질적으로 도움이 될 만한 개선점을 근거와 함께 설명)
5. 코칭 멘트 (실제 상담자에게 전달할 수 있는 구체적이고 실질적인 코칭 메시지, 따뜻하면서도 실질적인 코칭 멘트)
